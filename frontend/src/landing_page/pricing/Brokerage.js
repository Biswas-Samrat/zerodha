...
function Brokerage() {
  ...
  <div className="row p-md-5 mt-md-5 text-center border-top">
  <div className="col-12 p-4">
    ...
    <ul
      ...
      style={{ textAlign: "left", lineHeight: "2", fontSize: "0.9rem" }}
    >
      <li>
        Call & Trade and RMS auto-squareoff: Additional charges of ₹50 + GST per
        order.
      </li>
